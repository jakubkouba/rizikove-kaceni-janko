...
<div id="contact" class="section visible corner-bottom">
	...
	<div id="email-form">
		<p style="text-align:center">Pro okamžitý kontak použijte následující emailový formulář</p>
		<form id="send-email"  method="post" action="">
			...
			<label for="predmet">predmet:</label><input type="text" name="subject" id="subject" size=50><br/>
			<label for="mail_text">zprava:</label><textarea name="mail_text" id="mail_text" rows=10 cols=50></textarea>
			<button type="button" id="send2">Odešli</button>
		</form>
	</div>
